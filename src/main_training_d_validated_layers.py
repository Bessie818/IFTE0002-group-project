...
experiment_configs = [
    {"attention_type": "single", "num_layers": 1},
    {"attention_type": "single", "num_layers": 2},
    {"attention_type": "single", "num_layers": 3},
    {"attention_type": "multi", "num_layers": 1},
    {"attention_type": "multi", "num_layers": 2},
    {"attention_type": "multi", "num_layers": 3},
]
...
for config in experiment_configs:
    ...
    print("\n" + "=" * 70)
    print(f"Running validated layer tuning: attention_type={attention_type}, num_layers={num_layers}")
    print("=" * 70)
